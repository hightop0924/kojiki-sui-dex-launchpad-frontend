...
import SwitchBtnImg from '../../assets/switch_btn.png'

const StyledSwitchBtn = styled.img`
  width: 100%;
  height: 100%;
  padding: 4px;
`
export default function Swap() {
  ...
  const [exchangeArrowRotating, setExchangeArrowRotating] = useState<boolean>(false);
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'sm'}>
            <div style={{ display: 'relative' }}>
              ...
              />
              <ArrowWrapper clickable={isSupportedChain(chainId)} rotating={exchangeArrowRotating} 
                onClick={() => { 
                  setExchangeArrowRotating(true);
                  setTimeout(() => {setExchangeArrowRotating(false)}, 300)
                }}
              >
                {/*<ArrowDown
                  size="32"
                ...
                />*/}
                <StyledSwitchBtn src={SwitchBtnImg} 
                  onClick={() => {
                    onSwitchCoins()
                  }}
                />

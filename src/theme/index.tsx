...
function oldColors(darkMode: boolean): Colors {
  return {
    ...
    deprecated_bg1: darkMode ? '#212429' : '#f0f0f0',//'#F7F8FA',
    ...
    //primary colors
    deprecated_primary1: darkMode ? '#2172E5' : '#2172E5',// '#2172E5' : '#E8006F',
    ...
    // secondary colors
    deprecated_secondary1: darkMode ? '#2172E5' : '#2172E5', // '#2172E5' : '#E8006F',
